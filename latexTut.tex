...
K-Maps are very useful when working with Boolean Algebra. A package exists that makes them much simpler to produce, but is not included with \LaTeX\ like the other packages have been. Instead the kmap.sty file must be placed in the same directory as the .tex file.
...
\begin{itemize}
    ...
    \item Even more - A search for \LaTeX\ cheat sheet 
\end{itemize}
\end{document}
